                            ...
                            <div class="card-body">
                                ...
                                <form class="theme-form theme-form-2 mega-form" method="POST"
                                    ...
                                    <div class="mb-4 row align-items-center">
                                        ...
                                        <div class="col-sm-9">
                                            <select class="js-example-basic-single w-100" disabled name="category_id">
                                    ...
                                    <div class="mb-4 row align-items-center">
                                        ...
                                        <div class="col-sm-9">
                                            <select class="js-example-basic-single w-100" disabled name="store_id">
                                    ...
                                    <div class="d-flex align-items-center mb-4 row">
                                        <label class="form-label-title col-sm-3 mb-0">
                                            Description</label>
                                        <div class="col-sm-9">
                                            <textarea name="description" disabled class="form-control" rows="3">{{ $product->description }}</textarea>
                                            @error('description')
                                                <p class="text-danger">{{ $message }}</p>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="mb-4 row align-items-center">
                                        ...
                                        <div class="col-sm-9">
                                            <input class="form-control" disabled value="{{ $product->price }}" name="price"
                                    ...
                                    <div class="mb-4 row align-items-center">
                                        ...
                                        <div class="col-sm-9">
                                            <input class="form-control" disabled value="{{ $product->discount_precentage }}"
                                    ...
                                    <div class="mb-4 row align-items-center">
                                        ...
                                        <div class="col-sm-9">
                                            <input class="form-control" disabled name="in_stock" value="{{ $product->in_stock }}"
                                                type="number" placeholder="0">
                                            @error('in_stock')
                                                <p class="text-danger">{{ $message }}</p>
                                            @enderror
                                    ...
                                    <div class="mb-4 row align-items-center">
                                        ...
                                        <div class="col-sm-9">
                                            <input value="{{ old('images') }}" disabled class="form-control form-choose"
